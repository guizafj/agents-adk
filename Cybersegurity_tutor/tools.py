...
def ping_check(target: str, count: int = 4) -> dict:
    ...
    try:
        ...
        return {"status": "error", "error_message": f"Error al ejecutar ping: {str(e)}"}
...
def whois_lookup(domain: str) -> dict:
    ...
    try:
        ...
        return {"status": "success", "domain": domain, "result": result.stdout}
    except FileNotFoundError:
        return {
            "status": "error",
...
def dns_lookup(domain: str, record_type: str = "A") -> dict:
    ...
    try:
        ...
        return {"status": "error", "error_message": f"Error al ejecutar dig: {str(e)}"}
